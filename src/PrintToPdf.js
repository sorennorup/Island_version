PrintToPdf = function(results1,results2,results3,labelarr){
	...
	this.downloadResultsOnly = function(){
		...
		var dd = {
			...
			table: {
				...
				body: [labelarr,
					...
					results1,
					[{text: 'MÅL', colSpan: 6, alignment: 'left',style: 'profile2Text'}],
					results2,
		...
		table: {	
			body:[	
					...
					[{text: 'MÅL', alignment: 'left',style: 'profile2Text'}],
	...
	createCommentArray = function (commentArr) {
		let comments = [];
		let labels = ['MÅLSÆTNING','MOTIVATION','ROBUSTHED','FLEKSIBILITET','SOCIALE NORMER','MIN FAGLIGHED'];
